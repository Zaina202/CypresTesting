describe('Staff page',()=>{
  ...
  it('edit first name of staff by valid user name',()=>{
        ...
        it('edit of staff Observe permission', () => {
          ...
          cy.get('select[name="permissions_Observe"][form="form_staff_Talaa"]').select('0', { force: true });
         cy.get('button[type="submit"].btn.btn-primary[form="form_staff_Talaa"][onclick="saveEditRow(\'Talaa\')"]')
            .click({ force: true });
        });
        ...
        it('edit of staff  permission', () => {
          ...
          cy.get('select[name="permissions_Staff"][form="form_staff_Talaa"]').select('1', { force: true });
          cy.get('@Save')
            .click({ force: true });
        });
